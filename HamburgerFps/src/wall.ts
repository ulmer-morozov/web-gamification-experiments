...
export class Wall {
    ...
    createMesh = (params: { wallHeight: number, wallThickness: number }): BABYLON.Mesh => {
        ...
        const innerWallIndices = Wall.createIndices({
            closed: closed,
            clockwise: true,
        ...
        const outerWallIndices = Wall.createIndices({
            closed: closed,
            clockwise: false,
        ...
        const topIndices = Wall.createIndices({
            closed: closed,
            clockwise: true,
        ...
        const bottomIndices = Wall.createIndices({
            closed: closed,
            clockwise: false,
            positionsOne: bottomInnerPositions,
        ...
        const innerWallUVs = Wall.createWallUVs({
            closed: closed,
            wallHeight: wallHeight,
            corners: this.corners
        });

        const outerWallUVs = Wall.createWallUVs({
            closed: closed,
            wallHeight: wallHeight,
